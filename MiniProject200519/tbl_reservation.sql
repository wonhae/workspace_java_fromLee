...
■INNER JOIN 해보기 (부모자식 상관없다)
select c.id 고객ID, c.name 고객성함, m.mvId 영화관ID, m.title 영화관명, r.rsv_id 예매번호, r.day 예매날짜, r.rsvTime 상영시간대, r.num 예매인원, r.paymentMethod 결제방법, r.total 총금액
from rsv r
...
--//UNION VS. VIEW
■ VIEW 생성
create or replace view V_rsv as
